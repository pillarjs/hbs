...
function middleware(filename, options, cb) {
  ...
  var layout_filename = undefined;
  var view_dirs = [].concat(options.settings.views);

  view_dirs.some(function (view_dir) {
    var loc = path.resolve(view_dir, layout || 'layout');
